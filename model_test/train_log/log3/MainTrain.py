...
# 日志文件路径
log_file = os.path.join(output_dir, 'train_3(150).log')
...
def update_saved_model(model, path):
    ...
    save_path = os.path.join(path, 'real_data_model_net_new_3.pth')
...
# ———— 主训练流程 ————
# =========================
if os.path.exists('real_data_model_net_new_2.pth'):
    model.load_state_dict(torch.load('real_data_model_net_new_2.pth'))
    # print("Loaded saved model")
if __name__ == '__main__':
    # 打开 CSV 文件并写入表头
    csv_path = 'loss_values_net_new_3.csv'
